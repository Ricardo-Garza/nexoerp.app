...
export const DASHBOARD_INDICATOR_CATALOG: DashboardIndicatorDefinition[] = [
  ...
  { id: "stockBajo", name: "Stock bajo", description: "SKUs por debajo de su mínimo", source: "Inventario y Existencias" },
  { id: "inventarioDisponible", name: "Inventario disponible", description: "Existencias disponibles totales", source: "Inventario y Existencias" },
